...
{
    public class PickDetailViewModel : BindableBase, INavigationAware
    {
        ...
        private void OnOpenGripperControl()
        {
            ...
            _dialogService.ShowDialog("GripperControlView", parameters, result =>
            {
                ...
                {
                    if (result.Parameters.ContainsKey("clampPosition"))
                        ClampPosition = result.Parameters.GetValue<double>("clampPosition");

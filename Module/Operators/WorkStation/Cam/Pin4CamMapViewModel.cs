...
{
    public class Pin4CamMapViewModel : CamHighCmpViewModel<string>
    {
        private string _pinDisplayName = "Pin4飞拍位置";
        public string PinDisplayName
        {
            get => _pinDisplayName;
            set => SetProperty(ref _pinDisplayName, value);
        }
        protected override int CamIndex => 4; // 标识当前处理Pin4
        //private readonly Task2 _task2;
        public Pin4CamMapViewModel(
        ...
        protected override async void MoveToPoint(PointViewModel point)
        {
            ...
            await Task.Run(() =>
            {
                //_task2.GantryStation_MoveToVisionInspPosn4(point.X, point.Y);
            });
        }
    }
}

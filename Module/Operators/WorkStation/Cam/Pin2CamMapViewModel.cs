...
{
    public class Pin2CamMapViewModel : CamHighCmpViewModel<string>
    {
        private string _pinDisplayName = "Pin2飞拍位置";
        public string PinDisplayName
        {
            get => _pinDisplayName;
            set => SetProperty(ref _pinDisplayName, value);
        }
        protected override int CamIndex => 2; // 标识当前处理Pin2
        //private readonly Task2 _task2;
        public Pin2CamMapViewModel(
        ...
        protected override async void MoveToPoint(PointViewModel point)
        {
            ...
            await Task.Run(() =>
            {
                //_task2.GantryStation_MoveToVisionInspPosn2(point.X, point.Y);
            });
        }
    }
}

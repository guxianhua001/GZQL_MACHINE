...
//using System.Runtime.Serialization.Formatters.Soap; // .NET 9 中已移除 SoapFormatter
using System.Runtime.Serialization.Formatters.Binary;

namespace HalconWrapper.Config
{
    public class SerializeHelper
    {
        ...
        //}
        #endregion
        #region SoapFormatter序列化（已弃用 - .NET 9 中 SoapFormatter 已移除）
        /// <summary>
        /// SoapFormatter序列化（已弃用：.NET 9 中 SoapFormatter 已移除，建议使用 XML 序列化替代）
        /// </summary>
        /// <param name="item">对象</param>
        ...
        //}
        /// <summary>
        /// SoapFormatter反序列化（已弃用：.NET 9 中 SoapFormatter 已移除，建议使用 XML 反序列化替代）
        /// </summary>
        /// <param name="str">字符串序列</param>

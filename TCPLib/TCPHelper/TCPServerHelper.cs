 ...
 * 唯一标识：97a2653b-0865-442d-9957-1a2b04c17387
 * 文件名：TCPServerHelper
 * 
 * 创建者：szb
 * 创建时间：2024/8/12 15:29:54
 * 版本：V1.0.0
 * 描述：
 *
 * ----------------------------------------------------------------
...
namespace TCPLib.TCPHelper
{
    public class TCPServerHelper
    {
        ...
        // 使用线程安全字典保存活动会话
        private ConcurrentDictionary<SessionId, Session> activeSessions = new();
        /// <summary> 
        /// 当前的连接的客户端数 
        /// </summary> 
        ...
        public virtual void CloseSession(Session closeClient)
        {
            ...
            if (closeClient != null)
            {
                ...
                activeSessions.TryRemove(closeClient.ID, out _);
                _clientCount--;
        ...
        {
            foreach (var session in activeSessions.Values.ToList()) // ToList防止迭代时修改
            {
                try
                {
        ...
        protected virtual void AcceptConn(IAsyncResult iar)
        {
            ...
            else
            {
                ...
                activeSessions.TryAdd(newSession.ID, newSession);
                //客户端引用计数+1
                _clientCount++;
                ...
                if (ClientConn != null)
                {
                    newSession.RemoteIP = client.RemoteEndPoint.ToString();
        ...
        protected virtual void ReceiveData(IAsyncResult iar)
        {
            ...
            try
            {
                ...
                if (RecvData != null)
                {
                    ...
                    clientSession.RemoteIP = client.RemoteEndPoint.ToString();

...
namespace SmarterMotion
{
    public abstract class XEventServerBase : XObject
    {
        ...
        public abstract void PostEvent(XEventHandler target, XEventID eventID, XEventArgs eventArgs = null, XObject sender = null, bool isPriority = false, int currenttaskid = -2);
        ...
        public void Start()
        {
            ...
            this.worker = Task.Factory.StartNew(
                () => this.ProcessEventQueue(this.stopToken.Token),   //执行了XEventServer => ProcessEventQueue

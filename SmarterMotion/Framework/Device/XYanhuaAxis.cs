...
{
    public class XYanhuaAxis : XObject, IAxis
    {
        ...
        public XYanhuaAxis(int actAxisId, double lead, XCard card, string name)
        {
        ...
        public double VEL => throw new System.NotImplementedException();

        public int AxisAdr { get => throw new System.NotImplementedException(); set => throw new System.NotImplementedException(); }
